...
lastmod: 2025-12-08T00:07:23+00:00
...
With that in mind, I started looking for a tool capable of performing this functionality. I came across [Lunr](https://lunrjs.com/guides/getting_started.html), Duckduck Go custom search engine, and Simple Jekyll Search.
...
Also, I've added the post's content to the **search.json** file, so we're now also able to search for some specific content or paragraph that the `{title}` or the page `{description}` themselves don't have.
