...
date: 2022-09-28T10:20:00+00:00
lastmod: 2025-12-08T00:27:34+00:00
...
- Podman;
- Caddy (or any other webserver of your choice);
...
For other distros, or if you'd like to install from source, see the [podman documentation](https://podman.io/getting-started/installation).
...
For other distros, or if you'd like to install from source, see the [caddy documentation](https://caddyserver.com/docs/install).
...
Make sure to edit the first line with your own domain.tld, and the sixth line with the email you'd like to use when generating your SSL certificate.  
Caddy will take care of the certificate automatically for you.
...
- Configure Systemd, so you can have your container start at boot;
- Update your container;
- Head to the official documentation, so you can configure any additional settings.
...
The Vaultwarden container we just created is compatible with upstream [Bitwarden clients](https://bitwarden.com/download/).

Remember to edit the settings of the application before login. You must point to your custom Server URL.

If you need additional help, check out the [Bitwarden Help Center](https://bitwarden.com/help/).
...
--**memory** - limits the total amount of memory used by the container (you can definitely change this value as needed or even ignore this flag;  
